...
This project implements a  link-state routing protocol in TinyOS. It reuses Project 1’s Neighbor Discovery (ND) to learn 1-hop neighbors and Flooding to spread Link-State Advertisements (LSAs). The protocol runs in four phases:
