...
# This class implements a Python interface to the 'CommandMsg' message type
...
class CommandMsg(tinyos.message.Message.Message):
    ...
    # Return the number of elements in the array 'payload' for the given dimension
